...
use crate::sdk::core_types::{DEFAULT_FINAL_CLTV_EXPIRY_DELTA, HTLC_MIN_MSAT};
use crate::sdk::ldk::{ChannelIdsMap, Router};
use crate::sdk::rgb::{get_rgb_channel_info_optional, RgbLibWalletWrapper};
use crate::sdk::args::UserArgs;
use crate::sdk::disk::FilesystemLogger;
use crate::sdk::error::{APIError, AppError};
use crate::sdk::ldk::{
...
impl AppState {
    ...
    pub(crate) fn load_revoked_tokens(&self) -> Result<HashSet<Vec<u8>>, AppError> {
        ...
        for line_res in reader.lines() {
            ...
            let token_id = hex_str_to_vec(s).ok_or(AppError::InvalidRevokedTokensFile)?;
...
pub(crate) fn get_route(
    channel_manager: &crate::sdk::ldk::ChannelManager,
    router: &crate::sdk::ldk::Router,
    start: PublicKey,
    dest: PublicKey,
