...
use lightning::rgb_utils::{
    get_rgb_channel_info_pending, is_channel_rgb, read_pending_funding_acceptance,
    remove_pending_funding_acceptance, update_rgb_channel_amount, FundingAcceptanceStage,
    PendingFundingAcceptance, RgbKvStoreExt, RGB_CHANNEL_INFO_NS, RGB_CHANNEL_INFO_PENDING_NS,
...
use rgb_lib::{
    ...
    Fascia, FileContent, RgbTxid, TransferStatus, WitnessOrd,
};
...
fn sender_transfer_status(
    ...
    let transfers = wallet.list_transfers_by_txid(funding_txid.to_owned())?;
